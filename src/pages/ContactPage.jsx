...
function ContactPage() {
  ...
  const quickSearchOptions = [
    { label: 'Cứu hộ giao thông', keyword: 'cứu hộ giao thông, xe cứu hộ', icon: 'fa-truck-pickup', color: '#ea580c' },
    { label: 'Gara sửa xe', keyword: 'gara sửa xe ô tô xe máy', icon: 'fa-wrench', color: '#4b5563' },
    { label: 'Vá lốp lưu động', keyword: 'vá xe lưu động', icon: 'fa-motorcycle', color: '#ca8a04' },
    { label: 'Bệnh viện gần nhất', keyword: 'bệnh viện, trạm y tế', icon: 'fa-hospital', color: '#dc2626' },
    { label: 'Cây xăng', keyword: 'trạm xăng', icon: 'fa-gas-pump', color: '#2563eb' },
    { label: 'Nhà nghỉ/Khách sạn', keyword: 'nhà nghỉ, khách sạn', icon: 'fa-bed', color: '#7c3aed' },
  ];
  ...
  const handleExternalSearch = (keyword) => {
    ...
    const url = `http://googleusercontent.com/maps.google.com/maps?q=${encodeURIComponent(keyword)}/@${userLocation.lat},${userLocation.lng},14z`;
